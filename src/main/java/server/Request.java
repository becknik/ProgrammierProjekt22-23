...
public class Request {
	...
	public String getPath () {
		...
		//TODO path returns /<file name> but not /website/<filename> for css and js files, but for html file works
		if (path == "/website/website.html") return path;
		return "/website" + path;
	}
	...
	public boolean parse () throws IOException {
		String initialLine = this.in.readLine();
		log(initialLine);
